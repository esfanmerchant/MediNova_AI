...
from tests.conftest import ADMIN_EMAIL, password_for, requires_db, requires_demo_data

pytestmark = [requires_db, requires_demo_data]
...
class TestTheExport:
    def test_a_patient_gets_their_own_record(self, client: TestClient) -> None:
        ...
        assert bundle["format"] == "medinova.patient-export"
