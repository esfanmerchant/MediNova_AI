...
class TestWhatTheModelIsTold:
    def test_the_platform_brief_is_in_every_context(self) -> None:
        ...
        # Compared against the brief itself rather than a copy of its wording.
        # This asserted the literal "ABOUT MEDISENSE" until the product was
        # renamed, at which point it failed for a reason that had nothing to do
        # with what it is checking: that the brief reaches the model at all.
        assert assistant.PLATFORM_BRIEF in context
