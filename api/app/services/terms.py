...
TERMS: list[Section] = [
    Section(
        "What MediNova AI is",
        [
            "MediNova AI connects patients with doctors: you can find a doctor, book "
            "an appointment, keep your medical records in one place, and pay for "
            "your visits.",
            "MediNova AI is not a medical provider. The doctors on this platform are "
    ...
    Section(
        ...
        [
            "Consultation fees are set by each doctor. MediNova AI adds a platform fee "
            ...
            "confirmed by a person at MediNova AI. Uploading a screenshot is not "
    ...
    Section(
        ...
        [
            ...
            "If an invoice remains unpaid after it is due, MediNova AI may recover the "
            ...
            "between you and MediNova AI; it is not a clinical matter and is not "
    ...
    Section(
        ...
        [
            ...
            "Do not use MediNova AI to harass anybody, to obtain medication "
