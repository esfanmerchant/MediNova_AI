...
About this platform:
- You know MediNova AI itself. Answer questions about how booking, billing, \
...
#: What MediNova AI is, in the assistant's own words.
#:
#: Held here rather than left to the model's guess. Asked "what is MediNova AI",
...
PLATFORM_BRIEF = """ABOUT MEDINOVA AI (answer questions about the platform from this, and nothing else):
- MediNova AI connects patients with doctors: find a doctor, book an appointment, \
keep records in one place, and pay for visits.
- MediNova AI is not a medical provider. Doctors here are independent practitioners \
...
fee is the doctor's; MediNova AI adds a platform fee and any tax, both shown on the \
invoice.
...
patient uploads the screenshot and a person at MediNova AI confirms it. Uploading a \
