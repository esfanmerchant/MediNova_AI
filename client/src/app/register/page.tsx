        ...
        <form onSubmit={onSubmit} className="space-y-5" noValidate>
          ...
          <div className="space-y-2">
            <Checkbox
              ...
              label={tr(
                "I have read and accept the terms, and agree that MediNova AI may store my health information to provide my care.",
                "Main ne shara-it parh li hain aur qubool karta hoon, aur ittefaq karta hoon ke MediNova AI meri sehat ki maloomat ilaj ke liye mehfooz rakh sakta hai.",
              )}
            />
