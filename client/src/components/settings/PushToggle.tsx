    ...
    >
      {state === "denied" ? (
        <p className="text-sm leading-relaxed text-muted">
          {tr(
            "This browser has blocked notifications for MediNova AI. Only the browser can undo that — open the padlock beside the address bar, allow notifications, and reload this page.",
            "Is browser ne MediNova AI ke notifications rok rakhe hain. Yeh sirf browser hi wapas khol sakta hai — address bar ke paas taala kholein, notifications ki ijazat dein, aur is safhe ko reload karein.",
          )}
        </p>
      ) : (
