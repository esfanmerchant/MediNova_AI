  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <motion.div
            key="panel"
            role="dialog"
            aria-label={tr("MediNova AI Assistant", "MediNova AI Assistant")}
      ...
      <motion.button
        type="button"
        aria-expanded={open}
        aria-label={open ? tr("Close the assistant", "Assistant band karein") : tr("Ask the MediNova AI Assistant", "MediNova AI Assistant se poochein")}
        onClick={toggle}
