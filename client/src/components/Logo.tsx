/**
 * The MediNova AI mark, drawn from the logo: a rounded cross carrying an EKG
 * trace, with circuit nodes branching out of its right arm, all on the
 * blue→teal brand gradient. The wordmark sets "Medi" in blue, "Nova" in mid blue and "AI"
